...
public class LaunchPage3 extends BasePage {
	...
	public LoginPage goToLoginPage() {
		...
		//LoginPage class's constructor will be call and pass the driver
		//in it. LoginPage constructor will be initialize and LoginPage
		//constructor call the BasePage constructor. LoginPage constructor
		//send driver to the BasePage constructor and BasePage constructor 
		//initialize the driver for all pages. So same driver will 
		//for all pages.
	}
